...
@Tag(name = "Préstamos", description = " Administradocion de prestamos y devoluciones de libros")
public class LoanController {
    ...
    @PostMapping
    @Operation(summary = "Crear un préstamo", description = "Anota el préstamo de un libro a un usuario")
    ...
    @PutMapping("/return")
    @Operation(summary = "Devolver un libro", description = "Registra la devolución de un libro previamente prestado")
    ...
    @GetMapping
    @Operation(summary = "Historial de préstamos", description = "retorna todos los préstamos registrados, activos y devueltos")
